...
trait SetDefaultOrganizationAndWorkspace
{
    protected static function bootSetDefaultOrganizationAndWorkspace() {
        static::created(function ($model) {
            ...
            $adminService->setOrganizations($model->id, $public_org->id, Roles::editor);
            $adminService->setWorkspaces($model->id, $public_wsp->id, Roles::reader);
            ...
            // $adminService->setOrganizations($model->id, $personal_org->id, Roles::manager);
            // $adminService->setWorkspaces($model->id, $personal_wsp->id, Roles::manager);
