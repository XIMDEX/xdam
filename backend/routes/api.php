...
Route::group(['prefix'=>'v1','as'=>'v1'], function(){
    ...
    Route::group(['middleware' => 'auth:api'], function () {
        ...
        Route::group(['prefix' => 'workspace', 'middleware' => 'can:' . Abilities::canManageWorkspace], function(){
        ...
        Route::group(['middleware' => 'can:'.Abilities::canManageRoles], function() {
        ...
        Route::group(['prefix' => 'user'], function(){
            ...
            Route::group(['prefix' => 'organizations'], function(){
                ...
                Route::post('/select',                      [UserController::class, 'selectOrganization'])          ->name('user.select.organization');
